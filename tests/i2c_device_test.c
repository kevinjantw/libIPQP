...
void test_apdu_i2c_status_check(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);

    uint8_t status[2] = {0x00, 0x00};
    int ret = apdu_i2c_status_check(i2c_conf, status);

    printf("test_apdu_i2c_status_check(): %d\r\n", ret);
    printf("status: %02X %02X\r\n", status[0], status[1]);

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_kem_kyber512_keypair(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_keypair(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_512, (uint8_t *)pk, (uint8_t *)sk);
...
void test_apdu_i2c_kem_kyber768_keypair(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_keypair(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_768, (uint8_t *)pk, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_kem_kyber1024_keypair(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_keypair(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_1024, (uint8_t *)pk, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_kem_kyber512_encap(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_encap(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_512, (uint8_t *)pk, (uint8_t *)ss, (uint8_t *)ct);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_kem_kyber768_encap(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_encap(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_768, (uint8_t *)pk, (uint8_t *)ss, (uint8_t *)ct);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_kem_kyber1024_encap(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_encap(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_1024, (uint8_t *)pk, (uint8_t *)ss, (uint8_t *)ct);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_kem_kyber512_decap(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_decap(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_512, (uint8_t *)sk, (uint8_t *)ct, (uint8_t *)ss);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("Kyber512 shared scetet:\r\n");
        print_arr(ss, IPQP_KEM_kyber_512_length_shared_secret, 32, "SS");
...
void test_apdu_i2c_kem_kyber768_decap(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_decap(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_768, (uint8_t *)sk, (uint8_t *)ct, (uint8_t *)ss);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("Kyber768 shared scetet:\r\n");
        print_arr(ss, IPQP_KEM_kyber_768_length_shared_secret, 32, "SS");
...
void test_apdu_i2c_kem_kyber1024_decap(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_decap(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_1024, (uint8_t *)sk, (uint8_t *)ct, (uint8_t *)ss);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("Kyber1024 shared scetet:\r\n");
        print_arr(ss, IPQP_KEM_kyber_1024_length_shared_secret, 32, "SS");
...
void test_apdu_i2c_dsa_dilithium2_keypair(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_keypair(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_2, (uint8_t *)pk, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium3_keypair(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_keypair(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_3, (uint8_t *)pk, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium5_keypair(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_keypair(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_5, (uint8_t *)pk, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium2_sign(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_sign(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_2, (uint8_t *)sk, (uint8_t *)msg, KAT_DILITHIUM2_MLEN, (uint8_t *)sm, &smlen);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium3_sign(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_sign(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_3, (uint8_t *)sk, (uint8_t *)msg, KAT_DILITHIUM3_MLEN, (uint8_t *)sm, &smlen);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium5_sign(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_sign(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_5, (uint8_t *)sk, (uint8_t *)msg, KAT_DILITHIUM5_MLEN, (uint8_t *)sm, &smlen);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium2_verify(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_verify(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_2, (uint8_t *)pk, (uint8_t *)msg, (size_t)KAT_DILITHIUM2_MLEN, (uint8_t *)sm, (size_t)KAT_DILITHIUM2_SMLEN, &verified);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium3_verify(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_verify(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_3, (uint8_t *)pk, (uint8_t *)msg, (size_t)KAT_DILITHIUM3_MLEN, (uint8_t *)sm, (size_t)KAT_DILITHIUM3_SMLEN, &verified);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium5_verify(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_dsa_verify(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_5, (uint8_t *)pk, (uint8_t *)msg, (size_t)KAT_DILITHIUM5_MLEN, (uint8_t *)sm, (size_t)KAT_DILITHIUM5_SMLEN, &verified);
    if (ret == IPQP_EC_SUCCESS)
    {
...
void test_apdu_i2c_dsa_dilithium2_assign_public_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_2, APDU_CMD_P1_ASSIGN_DSA_PK, (uint8_t *)pk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("dilithium2 apdu_i2c_assign_key() success.\r\n");
    }
    else
    {
        printf("dilithium2 apdu_i2c_assign_key() failed. (%d)\r\n", ret);
    }

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_dsa_dilithium3_assign_public_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_3, APDU_CMD_P1_ASSIGN_DSA_PK, (uint8_t *)pk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("dilithium3 apdu_i2c_assign_key() success.\r\n");
    }
    else
    {
        printf("dilithium3 apdu_i2c_assign_key() failed. (%d)\r\n", ret);
    }

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_dsa_dilithium5_assign_public_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_5, APDU_CMD_P1_ASSIGN_DSA_PK, (uint8_t *)pk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("dilithium5 apdu_i2c_assign_key() success.\r\n");
    }
    else
    {
        printf("dilithium5 apdu_i2c_assign_key() failed. (%d)\r\n", ret);
    }

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_dsa_dilithium2_assign_secret_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_2, APDU_CMD_P1_ASSIGN_DSA_SK, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("dilithium2 apdu_i2c_assign_key() success.\r\n");
    }
...
void test_apdu_i2c_dsa_dilithium3_assign_secret_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_3, APDU_CMD_P1_ASSIGN_DSA_SK, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("dilithium3 apdu_i2c_assign_key() success.\r\n");
    }
...
void test_apdu_i2c_dsa_dilithium5_assign_secret_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_DILITHIUM_5, APDU_CMD_P1_ASSIGN_DSA_SK, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("dilithium5 apdu_i2c_assign_key() success.\r\n");
    }
...
void test_apdu_i2c_dsa_kyber_512_assign_secret_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_512, APDU_CMD_P1_ASSIGN_KEM_SK, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 512 apdu_i2c_assign_key() success.\r\n");
    }
    else
    {
        printf("kyber 512 apdu_i2c_assign_key() failed. (%d)\r\n", ret);
    }

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_dsa_kyber_768_assign_secret_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_768, APDU_CMD_P1_ASSIGN_KEM_SK, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 768 apdu_i2c_assign_key() success.\r\n");
    }
    else
    {
        printf("kyber 768 apdu_i2c_assign_key() failed. (%d)\r\n", ret);
    }

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_dsa_kyber_1024_assign_secret_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_1024, APDU_CMD_P1_ASSIGN_KEM_SK, (uint8_t *)sk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 1024 apdu_i2c_assign_key() success.\r\n");
    }
    else
    {
        printf("kyber 1024 apdu_i2c_assign_key() failed. (%d)\r\n", ret);
    }

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_dsa_kyber_512_assign_public_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_512, APDU_CMD_P1_ASSIGN_KEM_PK, (uint8_t *)pk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 512 apdu_i2c_assign_key() success.\r\n");
    }
...
void test_apdu_i2c_dsa_kyber_768_assign_public_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_768, APDU_CMD_P1_ASSIGN_KEM_PK, (uint8_t *)pk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 768 apdu_i2c_assign_key() success.\r\n");
    }
...
void test_apdu_i2c_dsa_kyber_1024_assign_public_key(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_assign_key(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_1024, APDU_CMD_P1_ASSIGN_KEM_PK, (uint8_t *)pk);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 1024 apdu_i2c_assign_key() success.\r\n");
    }
...
void test_apdu_i2c_dsa_kyber_512_assign_ciphertext(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_assign_ciphertext(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_512, APDU_CMD_P1_ASSIGN_KEM_CT, (uint8_t *)ct);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 512 apdu_i2c_kem_assign_ciphertext() success.\r\n");
    }
    else
    {
        printf("kyber 512 apdu_i2c_kem_assign_ciphertext() failed. (%d)\r\n", ret);
    }

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_dsa_kyber_768_assign_ciphertext(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_assign_ciphertext(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_768, APDU_CMD_P1_ASSIGN_KEM_CT, (uint8_t *)ct);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 768 apdu_i2c_kem_assign_ciphertext() success.\r\n");
    }
    else
    {
        printf("kyber 768 apdu_i2c_kem_assign_ciphertext() failed. (%d)\r\n", ret);
    }

    printf("[E N D]: %s()\r\n", __func__);
}

void test_apdu_i2c_dsa_kyber_1024_assign_ciphertext(i2c_conf_t *i2c_conf)
{
    printf("[START]: %s()\r\n", __func__);
    ...
    int ret = apdu_i2c_kem_assign_ciphertext(i2c_conf, APDU_CLA_ITRI, APDU_CMD_INS_ALGO_KYBER_1024, APDU_CMD_P1_ASSIGN_KEM_CT, (uint8_t *)ct);
    if (ret == IPQP_EC_SUCCESS)
    {
        printf("kyber 1024 apdu_i2c_kem_assign_ciphertext() success.\r\n");
    }
    else
    {
        printf("kyber 1024 apdu_i2c_kem_assign_ciphertext() failed. (%d)\r\n", ret);
    }
...
int main(int argc, char *argv[])
{
    ...
    void (*test_function)(i2c_conf_t *i2c_conf);
    test_function = NULL;

    switch (flag)
    {
    case 0:
        test_function = &test_apdu_i2c_status_check;
        break;

    case 1:
        test_function = &test_apdu_i2c_kem_kyber512_keypair;
        break;

    case 2:
        test_function = &test_apdu_i2c_kem_kyber768_keypair;
        break;

    case 3:
        test_function = &test_apdu_i2c_kem_kyber1024_keypair;
        break;

    case 11:
        test_function = &test_apdu_i2c_kem_kyber512_encap;
        break;

    case 12:
        test_function = &test_apdu_i2c_kem_kyber768_encap;
        break;

    case 13:
        test_function = &test_apdu_i2c_kem_kyber1024_encap;
        break;

    case 21:
        test_function = &test_apdu_i2c_kem_kyber512_decap;
        break;

    case 22:
        test_function = &test_apdu_i2c_kem_kyber768_decap;
        break;

    case 23:
        test_function = &test_apdu_i2c_kem_kyber1024_decap;
        break;

    case 31:
        test_function = &test_apdu_i2c_dsa_dilithium2_keypair;
        break;

    case 32:
        test_function = &test_apdu_i2c_dsa_dilithium3_keypair;
        break;

    case 33:
        test_function = &test_apdu_i2c_dsa_dilithium5_keypair;
        break;

    case 41:
        test_function = &test_apdu_i2c_dsa_dilithium2_sign;
        break;

    case 42:
        test_function = &test_apdu_i2c_dsa_dilithium3_sign;
        break;

    case 43:
        test_function = &test_apdu_i2c_dsa_dilithium5_sign;
        break;

    case 51:
        test_function = &test_apdu_i2c_dsa_dilithium2_verify;
        break;

    case 52:
        test_function = &test_apdu_i2c_dsa_dilithium3_verify;
        break;

    case 53:
        test_function = &test_apdu_i2c_dsa_dilithium5_verify;
        break;

    case 61:
        test_function = &test_apdu_i2c_dsa_dilithium2_assign_public_key;
        break;

    case 62:
        test_function = &test_apdu_i2c_dsa_dilithium3_assign_public_key;
        break;

    case 63:
        test_function = &test_apdu_i2c_dsa_dilithium5_assign_public_key;
        break;

    case 71:
        test_function = &test_apdu_i2c_dsa_dilithium2_assign_secret_key;
        break;

    case 72:
        test_function = &test_apdu_i2c_dsa_dilithium3_assign_secret_key;
        break;

    case 73:
        test_function = &test_apdu_i2c_dsa_dilithium5_assign_secret_key;
        break;

    case 81:
        test_function = &test_apdu_i2c_dsa_kyber_512_assign_secret_key;
        break;

    case 91:
        test_function = &test_apdu_i2c_dsa_kyber_512_assign_public_key;
        break;

    case 101:
        test_function = &test_apdu_i2c_dsa_kyber_512_assign_ciphertext;
        break;

    case 82:
        test_function = &test_apdu_i2c_dsa_kyber_768_assign_secret_key;
        break;

    case 92:
        test_function = &test_apdu_i2c_dsa_kyber_768_assign_public_key;
        break;

    case 102:
        test_function = &test_apdu_i2c_dsa_kyber_768_assign_ciphertext;
        break;

    case 83:
        test_function = &test_apdu_i2c_dsa_kyber_1024_assign_secret_key;
        break;

    case 93:
        test_function = &test_apdu_i2c_dsa_kyber_1024_assign_public_key;
        break;

    case 103:
        test_function = &test_apdu_i2c_dsa_kyber_1024_assign_ciphertext;
        break;

    default:
        printf("-----------------------------------\r\n");
        printf("  0:: test_apdu_i2c_status_check()\r\n\r\n");

        printf("  1:: test_apdu_i2c_kem_kyber512_keypair()\r\n");
        printf("  2:: test_apdu_i2c_kem_kyber768_keypair();\r\n");
        printf("  3:: test_apdu_i2c_kem_kyber1024_keypair();\r\n\r\n");

        printf(" 11:: test_apdu_i2c_kem_kyber512_encap();\r\n");
        printf(" 12:: test_apdu_i2c_kem_kyber768_encap();\r\n");
        printf(" 13:: test_apdu_i2c_kem_kyber1024_encap();\r\n\r\n");

        printf(" 21:: test_apdu_i2c_kem_kyber512_decap();\r\n");
        printf(" 22:: test_apdu_i2c_kem_kyber768_encap();\r\n");
        printf(" 23:: test_apdu_i2c_kem_kyber1024_decap();\r\n\r\n");

        printf(" 31:: test_apdu_i2c_dsa_dilithium2_keypair();\r\n");
        printf(" 32:: test_apdu_i2c_dsa_dilithium3_keypair();\r\n");
        printf(" 33:: test_apdu_i2c_dsa_dilithium5_keypair();\r\n\r\n");

        printf(" 41:: test_apdu_i2c_dsa_dilithium2_sign();\r\n");
        printf(" 42:: test_apdu_i2c_dsa_dilithium3_sign();\r\n");
        printf(" 43:: test_apdu_i2c_dsa_dilithium5_sign();\r\n\r\n");

        printf(" 51:: test_apdu_i2c_dsa_dilithium2_verify();\r\n");
        printf(" 52:: test_apdu_i2c_dsa_dilithium3_verify();\r\n");
        printf(" 53:: test_apdu_i2c_dsa_dilithium5_verify();\r\n\r\n");

        printf(" 61:: test_apdu_i2c_dsa_dilithium2_assign_public_key();\r\n");
        printf(" 71:: test_apdu_i2c_dsa_dilithium2_assign_secret_key();\r\n\r\n");

        printf(" 62:: test_apdu_i2c_dsa_dilithium3_assign_public_key();\r\n");
        printf(" 72:: test_apdu_i2c_dsa_dilithium3_assign_secret_key();\r\n\r\n");

        printf(" 63:: test_apdu_i2c_dsa_dilithium5_assign_public_key();\r\n");
        printf(" 73:: test_apdu_i2c_dsa_dilithium5_assign_secret_key();\r\n\r\n");

        printf(" 81:: test_apdu_i2c_dsa_kyber_512_assign_secret_key();\r\n");
        printf(" 91:: test_apdu_i2c_dsa_kyber_512_assign_public_key();\r\n");
        printf("101:: test_apdu_i2c_dsa_kyber_512_assign_ciphertext();\r\n\r\n");

        printf(" 82:: test_apdu_i2c_dsa_kyber_768_assign_secret_key();\r\n");
        printf(" 92:: test_apdu_i2c_dsa_kyber_768_assign_public_key();\r\n");
        printf("102:: test_apdu_i2c_dsa_kyber_768_assign_ciphertext();\r\n\r\n");

        printf(" 83:: test_apdu_i2c_dsa_kyber_1024_assign_secret_key();\r\n");
        printf(" 93:: test_apdu_i2c_dsa_kyber_1024_assign_public_key();\r\n");
        printf("103:: test_apdu_i2c_dsa_kyber_1024_assign_ciphertext();\r\n\r\n");
    ...
    {
        if (i2c_open(&i2c_conf) < 0)
        {
            printf("fali to open interface.\r\n");
            return EXIT_FAILURE;
        }

        test_function(&i2c_conf);
